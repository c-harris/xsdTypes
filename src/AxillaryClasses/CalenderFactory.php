...
class CalenderFactory extends Calender
{
    ...
    {
        $monthDayTimezone = '/--(1[0-2]|0[1-9]])-(0[1-9]|1[0-9]|2[0-9]|3[0-1]|[1-9])([-+][0-1]\d:[0-6]\d|Z*)/';
    ...
    {
        $monthTimezone = '/--(1[0-2]|0[1-9]])([-+][0-1]\d:[0-6]\d|Z*)/';
    ...
    {
        $yearMonthTimezone = '/(\d{4})-(1[0-2]|0[1-9]])([-+][0-1]\d:[0-6]\d|Z*)/';
